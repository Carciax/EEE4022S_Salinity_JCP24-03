...
Given that the calibration resistance is known at $5\Omega\pm0.25\%$, the resistance between the electrodes can be calculated using the ratio the measured voltages as shown in \refeqn{eqn:electrode-calib-resistance}.
\begin{equation}
