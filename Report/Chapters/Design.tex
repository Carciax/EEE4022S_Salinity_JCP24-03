...
This communication is done using the RS485 connection and requires its own board to board communication protocol and all the expected transmissions and responses are shown in \reffig{fig:rs485-flowchart}.
