...
The expected resistance was then calculated to be between $3.75\Omega$ and $6.25\Omega$ using \refeqn{eqn:conductivity-from-resistance} and conductivity values for salinities between $40$ and $25$ on the Practical Salinity Scale PSS-78~\cite{ioc_teos_2010}.
...
One last switch point was added to the circuit for the gold electrode's fringe guards, an example of which is shown in \reffig{fig:au-measurement-circuit}.
