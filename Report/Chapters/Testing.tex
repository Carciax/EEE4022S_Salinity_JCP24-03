...
\begin{longtblr}[
        ...
        % colspec = {|q{0.75cm}|C|q{2cm}|q{2cm}|q{2cm}|}
...
The $R_{calibration}$, $R_1$ and the $r_e$ the standard rational function coefficients $p$ and $q$ as shown in \refeqn{eqn:resistance-rational}.
